...
const shellInstructions ="navigate using typed commands:¶¶about-me¶¶contact commands:¶   git   linkedin¶¶portfolio commands:¶   ppsqft-chicago¶   whirr¶   agent-link¶   bird-city¶¶(add -about to project name for more info)¶¶"   
 ...
 const mobileShellInstructions='<div class="mobileNav" id="about-me">about-me   </div><div class="mobileNav" id="git">git   </div><div class="mobileNav" id="whirr">whirr   </div><div class="mobileNav" id="agent-link">agent-link   </div><div class="mobileNav"  id="bird-city">bird-city</div>'